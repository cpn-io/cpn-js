...
//
//import com.indevstudio.cpnide.server.net.PetriNetModel;
...
//                if (!petriNetModel.isContain(sessionId))
//                    petriNetModel.initializePetriNet(sessionId, DOMParser.parse(new ByteArrayInputStream(jsonstr.getBytes(StandardCharsets.UTF_8)), "myNet.cpnide"));
//                else
