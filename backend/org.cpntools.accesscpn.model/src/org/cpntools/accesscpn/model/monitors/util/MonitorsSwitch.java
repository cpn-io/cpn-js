 ...
 * @generated
 */
public class MonitorsSwitch<T> extends Switch<T> {
	/**
 ...
 protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MonitorsPackageImpl.MONITOR: {
				Monitor monitor = (Monitor)theEObject;
				T result = caseMonitor(monitor);
				if (result == null) result = caseHasId(monitor);
				if (result == null) result = caseHasName(monitor);
