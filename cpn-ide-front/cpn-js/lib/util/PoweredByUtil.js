 ...
 *
 * @see https://github.com/cpn-io/license for more information.
 */
...
var BPMNIO_LOGO_URL = 'assets/img/cpn-logo.svg';
...
var LIGHTBOX_MARKUP =
  '<div class="bjs-powered-by-lightbox" style="' + LIGHTBOX_STYLES + '">' +
    ...
    '<div class="notice" style="' + NOTICE_STYLES + '">' +
      '<a href="https://github.com/cpn-io" target="_blank" style="float: left; margin-right: 10px">' +
        BPMNIO_IMG +
      '</a>' +
      'Web-based tooling for CPN diagrams<br>' +
      'powered by<br><a href="https://github.com/cpn-io" target="_blank">cpn-io</a>.' +
    '</div>' +
  '</div>';
