...
@Component({
  selector: 'app-project-declarations-old',
  templateUrl: './project-declarations-old.component.html',
  styleUrls: ['./project-declarations-old.component.scss']
})
export class ProjectDeclarationsOldComponent implements OnInit, OnDestroy {
