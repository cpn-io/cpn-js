...
export class EditorPanelService {
  ...
  public addModelEditor(modelEditor: ModelEditorComponent) {
    ...
    console.log(
      ...
      "addModelEditor(), this.modelEditorList = ",
  ...
  public removeModelEditor(modelEditor: ModelEditorComponent) {
    ...
    this.modelEditorList = this.modelEditorList.filter(function (e) {
      return e !== modelEditor;
    });

    console.log(
      this.constructor.name,
      "removeModelEditor(), this.modelEditorList = ",
      this.modelEditorList
    );
  }
  ...
  public clearModelEditorList() {
    ...
    console.log(
      this.constructor.name,
      "clearModelEditorList(), this.modelEditorList = ",
      this.modelEditorList
    );
  }
