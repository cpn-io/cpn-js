...
export default function AdaptiveLabelPositioningBehavior(eventBus, modeling) {
  ...
  this.postExecuted([
    ...
    checkLabelAdjustment(connection);
  });
  ...
  function checkLabelAdjustment(element) {
    ...
    if (element.waypoints) {
      ...
      var labelMid = getMid(label);

      var newLabelMid = getConnectionLabelPosition(element.waypoints);
      var delta = substract(newLabelMid, labelMid);
      delta.x += label.width / 2;
      delta.y += label.height / 2;
  ...
  //   console.log('AdaptiveLabelPositioningBehavior.adjustLabelPosition(), element = ', element, ', orientation = ', orientation);
