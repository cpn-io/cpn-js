 ...
 */
export function getConnectionLabelPosition(waypoints) {
...
export function getExternalLabelMid(element) {
  ...
  if (element.waypoints) {
    return getConnectionLabelPosition(element.waypoints);
  } else {
    return {
...
/**
 * Returns the bounds of an elements label
 */
export function getExternalLabelBounds(element) {

  var mid, size, bounds, label = element.label;
