...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/popup-menu/PopupMenuProvider.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/popup-menu/</a> PopupMenuProvider.js
    </h1>
    <div class='clearfix'>
 ...
 */
export default function PopupMenuProvider(popupMenu) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  this._popupMenu = popupMenu;</span>
&nbsp;
 ...
 *}
 */
PopupMenuProvider.getEntries = function(element) <span class="fstat-no" title="function not covered" >{};</span>
&nbsp;
&nbsp;
/**
 ...
 * };
 */
PopupMenuProvider.getHeaderEntries = function(element) <span class="fstat-no" title="function not covered" >{};</span>
&nbsp;
/**
 ...
 * }
 */
PopupMenuProvider.register = function() <span class="fstat-no" title="function not covered" >{};</span></pre></td></tr>
</table></pre>
